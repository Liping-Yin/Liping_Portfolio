...
- Artifitial Intelligence Basic
  ...
  split dataset by decision tree which is based on entropy and information gain:
  - write functions to calculate entropy and information gain
  - write functions to get the feature that maximizes information gain
  - use the feature to split our dataset
  - iterate through the whole dataset the same way above.
