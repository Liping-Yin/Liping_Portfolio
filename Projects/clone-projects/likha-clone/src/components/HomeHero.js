    ...
    <div className="home__hero">
      <div className="home__hero__tilt">
        ...
        <a
          ...
          class="link home__hero__award to-animate anim"
        >
          <img
      ...
      <button type="button" class="hero__arrow link">
        <ArrowDownSvg />
      </button>
      <svg class="clippath" viewBox="0 0 613 613" width="0" height="0">
